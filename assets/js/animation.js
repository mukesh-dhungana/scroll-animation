...
function myFunction() {
    ...
    for (a = 0; a < animationSectionLen; a++) {
        if (
            document
            .getElementsByClassName("animation-sections")[a].getBoundingClientRect().top +
        ...
        if (
            document
            .getElementsByClassName("animation-sections")[a].getBoundingClientRect().top < 2
        ) {
        ...
        if (
            document
            .getElementsByClassName("animation-sections")[a].getBoundingClientRect().top < 200 &&
            document
            .getElementsByClassName("animation-sections")[a].getBoundingClientRect().top > 2
        ) {
            //document.getElementById("videoDiv").style.width = "90%";
...
var transfromTransitionalSection = () => {
    ...
    for (item = 0; item < transitionalSectionLen; item++) {
        ...
        if (
            window.innerHeight -
            document
            .getElementsByClassName("transitional-section")[item].getBoundingClientRect().top <
            20
        ) {
        ...
        if (
            window.innerHeight -
            document
            .getElementsByClassName("transitional-section")[item].getBoundingClientRect().bottom >=
    ...
    setTimeout(() => {
        ...
        for (i = 0; i < homeAnimationLen; i++) {
            ...
            if (i == 0 || i == 1) {
                document.getElementsByClassName("home-animation")[
                    i
                ].style.transform = "translate(11vw, " + (-(offSetHeight / 2) - 100) + "px)";
            }
